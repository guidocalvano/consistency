...
mcne = MatrixCapsNetEstimator().init(architecture="build_semantic_convolution_axial_system_architecture")
...
results = mcne.train_and_test(sn, batch_size, epoch_count, max_steps, model_path=os.path.join(config.TF_MODEL_PATH, 'semantic_axial'))
